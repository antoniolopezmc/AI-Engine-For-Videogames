...
public class TestOffensiveRole extends ApplicationAdapter {
	...
	public void create() {		
        ...
        FJarcher1.initializeTacticalRole(new OffensiveArcher());
        ...
        FJarcher2.initializeTacticalRole(new OffensiveArcher());
        ...
        FJarcher3.initializeTacticalRole(new OffensiveArcher());
        ...
        FJarcher4.initializeTacticalRole(new OffensiveArcher());
        ...
        FJarcher5.initializeTacticalRole(new OffensiveArcher());
        ...
        FJarcher6.initializeTacticalRole(new OffensiveArcher());
        ...
        LDarcher2.initializeTacticalRole(new OffensiveArcher());
        ...
        LDarcher3.initializeTacticalRole(new OffensiveArcher());
        ...
        LDarcher4.initializeTacticalRole(new OffensiveArcher());
        ...
        LDarcher5.initializeTacticalRole(new OffensiveArcher());
        ...
        LDarcher6.initializeTacticalRole(new OffensiveArcher());
        ...
        LDarcher7.initializeTacticalRole(new OffensiveArcher());
