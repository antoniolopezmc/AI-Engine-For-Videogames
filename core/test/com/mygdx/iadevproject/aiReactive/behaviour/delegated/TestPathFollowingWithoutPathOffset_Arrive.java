...
public class TestPathFollowingWithoutPathOffset_Arrive extends ApplicationAdapter {
	...
	public void create() {
        ...
        gota.addToListBehaviour(new PathFollowingWithoutPathOffset_Arrive(gota, 20.0f, 100.0f, 10.0f, 50.0f, 1.0f, listaDePuntos, PathFollowingWithoutPathOffset_Arrive.MODO_PARAR_AL_FINAL));
        ...
        gota2.addToListBehaviour(new PathFollowingWithoutPathOffset_Arrive(gota2, 40.0f, 100.0f, 10.0f, 50.0f, 1.0f, listaDePuntos, PathFollowingWithoutPathOffset_Arrive.MODO_IDA_Y_VUELTA));
        ...
        gota3.addToListBehaviour(new PathFollowingWithoutPathOffset_Arrive(gota3, 40.0f, 100.0f, 10.0f, 50.0f, 1.0f, new LinkedList<Vector3>(), PathFollowingWithoutPathOffset_Arrive.MODO_IDA_Y_VUELTA));
        ...
        gota4.addToListBehaviour(new PathFollowingWithoutPathOffset_Arrive(gota4, 40.0f, 100.0f, 10.0f, 50.0f, 1.0f, listaSoloUnPunto, PathFollowingWithoutPathOffset_Arrive.MODO_IDA_Y_VUELTA));
