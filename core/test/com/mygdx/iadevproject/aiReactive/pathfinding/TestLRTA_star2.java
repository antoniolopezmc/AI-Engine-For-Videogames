...
public class TestLRTA_star2 {
	...
	public static void main(String[] args) {
		...
		Continuous_LRTA_star lrta_star = new Continuous_LRTA_star(costesDelTerreno, new EuclideanDistance(), 10, 10, 0, 0, 0, 9);
