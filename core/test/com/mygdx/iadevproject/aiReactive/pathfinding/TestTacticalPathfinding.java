...
public class TestTacticalPathfinding extends ApplicationAdapter {
	...
	// Creamos el objeto pathfinding.
	private static PointToPoint_PathFinding pf;
	// Creamos el comportamiento PathFollowing.
	private static PathFollowingWithoutPathOffset_Arrive pfo;
	...
	public void create() {		
        ...
        FJarcher1.setBounds(235.0f,1022.0f, IADeVProject.WORLD_OBJECT_WIDTH, IADeVProject.WORLD_OBJECT_HEIGHT);
        ...
        LDsoldier2.setBounds(244.0f,1271.0f, IADeVProject.WORLD_OBJECT_WIDTH, IADeVProject.WORLD_OBJECT_HEIGHT);
...
//        drop.addToListBehaviour(new Attack(drop, defensiveSoldier, defensiveSoldier.getRole().getDamageToDone()-20, defensiveSoldier.getRole().getMaxDistanceOfAttack()));
        ...
        pf = new PointToPoint_PathFinding(FJarcher1, 7.0f, PointToPoint_PathFinding.EUCLIDEAN_DISTANCE, IADeVProject.GRID_CELL_SIZE, FJarcher1.getPosition().x, 
        		FJarcher1.getPosition().y, 231.0f, 1450.0f,
        		IADeVProject.MAP_OF_COSTS, IADeVProject.GRID_WIDTH, IADeVProject.GRID_HEIGHT);
        pf.useTactialInformation();
	...
	public void render() {
       ...
       // drop.applyBehaviour();
        ...
        // Aplicamos el pathfinding.
        List<Vector3> puntos = pf.applyPathFinding();
        pfo = new PathFollowingWithoutPathOffset_Arrive(FJarcher1, 10.0f, 20.0f, 7.0f, 20.0f, 1.0f, puntos, PathFollowingWithoutPathOffset_Arrive.MODO_PARAR_AL_FINAL);
        FJarcher1.setListBehaviour(new TreeMap<Float, Behaviour>(new Comparator<Float>() {
			@Override
        ...
        FJarcher1.addToListBehaviour(pfo);
        FJarcher1.applyBehaviour();
	}
