...
public class TestSeek_Accelerated extends ApplicationAdapter {
	...
	public void create() {
        ...
        // Esto está hecho, una vez que se ha comprobado que el Flee acelerado funciona!
        ...
        bucket.addToListBehaviour(new Seek_Accelerated(bucket, drop, 50.0f));
	}
