...
import com.mygdx.iadevproject.behaviour.acceleratedUnifMov.AntiAlign_Accelerated;
import com.mygdx.iadevproject.model.Character;

public class TestAntiAlign_Accelerated extends ApplicationAdapter {
...
//        drop.addToListBehaviour(new Wander_NoAccelerated(drop, 50.0f, 10.0f));
        ...
        bucket.addToListBehaviour(new AntiAlign_Accelerated(bucket, drop, 50.0f, 20.0f, 5.0f, 10.0f, 1.0f));
	}
