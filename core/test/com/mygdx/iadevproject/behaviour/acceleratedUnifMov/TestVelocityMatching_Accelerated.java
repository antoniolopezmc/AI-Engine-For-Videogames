...
public class TestVelocityMatching_Accelerated extends ApplicationAdapter {
	...
	public void create() {
        ...
        drop.addToListBehaviour(new Seek_Accelerated(drop, drop1, 50.0f));
        
        
        bucket.setBounds(200.0f, 200.0f, 64.0f, 64.0f);
        bucket.setOrientation(0.0f);
        bucket.setVelocity(new Vector3(0,100,0));
        bucket.addToListBehaviour(new VelocityMatching_Accelerated(bucket, drop, 30.0f, 1.0f));
	}
