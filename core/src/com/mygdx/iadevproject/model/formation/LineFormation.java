...
public class LineFormation extends Formation {
	...
	protected List<Vector3> getCharactersPosition() {
		...
		if (this.getNumberOfComponents() > 0) {			
			...
			while (character <= this.getNumberOfComponents()/2) { // Primero, situamos la mitad de componentes a un lado de la posición de la formación.
			...
			while(character < this.getNumberOfComponents()) { // Despés, situamos el resto de componentes al otro lado de la posición de la formación.
