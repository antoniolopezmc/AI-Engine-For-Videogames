...
\begin{itemize}
 ...
 \item Debido a que los mecanismos de ataque y cura se han implementado de manera diferente al resto de presonajes normales, los estados \texttt{AttackEnemies} y \texttt{CureMe} hacen uso del método \texttt{exit()} de la interfaz \texttt{State} para que, cuando se sale de alguno de estos estados, se realicen las acciones correspondientes a dejar de atacar y curar.
